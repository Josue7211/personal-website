...
2. `sudo mkdir -p /var/www/docs-aparcedo/releases /var/www/docs-aparcedo/current`
...
ssh services-vm "ln -sfn /var/www/docs-aparcedo/releases/$TS /var/www/docs-aparcedo/current"
```
