...
This directory contains the memd configuration for `personal-website`.

## Quick Start

1. Set up the bundle:
   - `memd setup --output /home/josue/Documents/projects/personal-website/.memd`
2. Check readiness and repair drift when needed:
   - `memd doctor --output /home/josue/Documents/projects/personal-website/.memd`
   - `memd doctor --output /home/josue/Documents/projects/personal-website/.memd --repair`
3. Inspect the active config:
   - `memd config --output /home/josue/Documents/projects/personal-website/.memd`
4. Refresh the live wake-up surface:
   - `memd wake --output /home/josue/Documents/projects/personal-website/.memd --route auto --intent current_task --write`
...
6. Inspect the compact working-memory view when needed:
   - `memd resume --output /home/josue/Documents/projects/personal-website/.memd --route auto --intent current_task`
7. Before memory-dependent answers, run bundle-aware recall:
   - `memd lookup --output /home/josue/Documents/projects/personal-website/.memd --query "..."`

## Commands

- `memd commands --output /home/josue/Documents/projects/personal-website/.memd`
- `memd commands --output /home/josue/Documents/projects/personal-website/.memd --summary`
- `memd commands --output /home/josue/Documents/projects/personal-website/.memd --json`
- `memd setup --output /home/josue/Documents/projects/personal-website/.memd`
- `memd doctor --output /home/josue/Documents/projects/personal-website/.memd`
- `memd config --output /home/josue/Documents/projects/personal-website/.memd`
...
- For Codex, start from `.memd/wake.md`, then use `memd lookup --output /home/josue/Documents/projects/personal-website/.memd --query "..."` before memory-dependent answers.
