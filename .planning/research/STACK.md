...
**Domain:** High-end immersive personal portfolio website — Three.js 3D, GSAP scroll animations, Astro docs section
**Researched:** 2026-03-30
**Confidence:** HIGH (all core choices verified against current official sources and npm)
...
**For the immersive main site sections (Hero, Projects, Interests):**
...
**For page transitions between main site and docs:**
...
*Stack research for: immersive personal portfolio website with Three.js, GSAP, Astro*
*Researched: 2026-03-30*
